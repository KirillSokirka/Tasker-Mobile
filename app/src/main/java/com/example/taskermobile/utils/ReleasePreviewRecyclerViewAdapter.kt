...
class ReleasePreviewRecyclerViewAdapter(private val items: List<ReleasePreviewModel>?) : RecyclerView.Adapter<ReleasePreviewRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.release_preview, parent, false)
